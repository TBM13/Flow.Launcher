...
public ref struct InfoInterpolatedStringHandler(int literalLength, int formattedCount, Logger logger, out bool isEnabled)
{
    public ZLoggerInformationInterpolatedStringHandler InnerHandler = new(literalLength, formattedCount, logger.InternalLogger, out isEnabled);
