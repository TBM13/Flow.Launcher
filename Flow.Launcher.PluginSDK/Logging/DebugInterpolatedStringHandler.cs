...
public ref struct DebugInterpolatedStringHandler(int literalLength, int formattedCount, Logger logger, out bool isEnabled)
{
    public ZLoggerDebugInterpolatedStringHandler InnerHandler = new(literalLength, formattedCount, logger.InternalLogger, out isEnabled);
