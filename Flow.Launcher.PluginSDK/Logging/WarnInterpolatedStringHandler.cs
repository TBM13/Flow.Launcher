...
public ref struct WarnInterpolatedStringHandler(int literalLength, int formattedCount, Logger logger, out bool isEnabled)
{
    public ZLoggerWarningInterpolatedStringHandler InnerHandler = new(literalLength, formattedCount, logger.InternalLogger, out isEnabled);
