...
public ref struct CriticalInterpolatedStringHandler(
    int literalLength, int formattedCount, Logger logger, out bool isEnabled)
{
    public ZLoggerCriticalInterpolatedStringHandler InnerHandler = new(
        literalLength, formattedCount, logger.InternalLogger, out isEnabled);
